...
async function handler(m) {
  ...
  let onW6 = await this.isOnWhatsApp(njid6) || { isBusiness: false }
  
  let name7 = 'creator Xtreshe'
  number7 = owner[6].replace(/[^0-9]/g, '')
  let njid7 = number7 + '@s.whatsapp.net'
  let onW7 = await this.isOnWhatsApp(njid7) || { isBusiness: false }
...
`.trim()
  ...
  conn.send2Button(m.chat, `Mau Tanya Apa Ke Ownerku ?`,`Tuh owner Ku Jangan Galak² Ya >_<, Nanti Ku Banned Nanges`, 'Donasi', '.donasi', 'Source Code', '.sc', m)
  }
